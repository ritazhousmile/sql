...
BEGIN
            ...
            <div class="modal-content">
                <div id="formContainer_%2$s">
                    ...
                    <div style="margin-top: 20px; text-align: right;">
                        <button onclick="document.getElementById(''%1$s'').style.display=''none''" class="btn btn-default">
                            Cancel
                        </button>
                        <button 
                            onclick="(function() {
                ...
                <div id="statusContainer_%2$s" style="text-align:center; display:none;">
                    ...
                    <div class="loader" id="loader_%2$s"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    CASE WHEN rvn('Meat on the Bone?') = true THEN 
        -- Meat icon (after submission)
