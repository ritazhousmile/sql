...
BEGIN
    ...
    button_id := 'unstar_' || record_id;
    user_email := hs_current_user->>'email';
    ...
    <div>
        ...
        <div id="unstar_container_%1$s">
            <button 
                id="%1$s"
                onclick="(function() {
                    const buttonContainer = document.getElementById(''unstar_container_%1$s'');
                    ...
                    const deleteUrl = ''https://jag.highsystems.io/api/rest/v1/applications/eqj90dan6huihq/tables/%4$s/records'';
                    const deleteData = {
                        query: {
                            filters: [{
                                field: ''uknft94hxqvjkk'',
                                value: ''%2$s''
                            }, {
                                field: ''hafx38z1srugta'',
                                value: ''%3$s''
                            }]
                        }
                    };
                    ...
                    .catch(error => {
                        ...
                        alert(''Error unstarring record. Please try again.'');
